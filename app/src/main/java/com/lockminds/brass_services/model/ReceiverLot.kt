...
@Entity(tableName ="receiver_lots")
data class ReceiverLot(
    ...
    val horse: String?,
    val trailer: String?,
    val driver_cell: String?,
    val received_in_nakonde: String?,
    val tunduma_in: String?,
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeString(driver_cell)
        parcel.writeString(received_in_nakonde)
        parcel.writeString(tunduma_in)
        parcel.writeString(depature_date)
        parcel.writeString(check_in)
        parcel.writeString(check_out)
        parcel.writeString(action_description)
        parcel.writeString(checkpoint)
    ...
    companion object CREATOR : Parcelable.Creator<ReceiverLot> {
        override fun createFromParcel(parcel: Parcel): ReceiverLot {
            return ReceiverLot(parcel)
        }

        override fun newArray(size: Int): Array<ReceiverLot?> {
