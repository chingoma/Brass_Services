...
@Entity(tableName ="offload_lots")
data class OffloadLot(
    ...
    companion object CREATOR : Parcelable.Creator<OffloadLot> {
        override fun createFromParcel(parcel: Parcel): OffloadLot {
            return OffloadLot(parcel)
        }

        override fun newArray(size: Int): Array<OffloadLot?> {
